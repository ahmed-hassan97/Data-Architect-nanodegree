...
-- copy data from csv into main table 
select * from hr_schema.hr_dataset hd 
...
create table hr_schema.job (job_id serial primary key , job_title varchar(100));

-- insert data into table 
insert into hr_schema.job(job_title) select distinct job_title from hr_schema.hr_dataset
select * from hr_schema.job
---------------------------------------------------------------------------------------------------------------------------
-- create Employee table 
create table hr_schema.Employee (emp_id serial primary key ,emp_nm varchar(50) , email varchar(50) , hire_dt Date );

insert into hr_schema.Employee(emp_id , emp_nm , email , hire_dt) 
select distinct cast(emp_id as int)  ,emp_nm , email , cast(hire_dt as Date)  from hr_schema.hr_dataset

select * from hr_schema.job
---------------------------------------------------------------------------------------------------------------------------
-- create location table 
create table hr_schema.location (location_id serial primary key ,location varchar(50) , city varchar(50) , state varchar(50) , address varchar(100) );

---------------------------------------------------------------------------------------------------------------------------
-- create Department table 
create table hr_schema.department (department_id serial primary key , department_name varchar(50));
---------------------------------------------------------------------------------------------------------------------------
-- create Department table 
create table hr_schema.salary (salary_id serial primary key , salary int);

---------------------------------------------------------------------------------------------------------------------------
-- create eduction level 
create table hr_schema.education_level (ed_id serial primary key , education_level varchar(50));
---------------------------------------------------------------------------------------------------------------------------
-- create employment
